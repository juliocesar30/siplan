...
<table width='100%' cellspacing='1' cellpadding='4' style='border:0px;'>
  <tr>
    ...
    <td width='71%' valign='top' style='border:0px;'><span class='titulo'><b>Unidad de Planeaci&oacute;n<br>
      ...
      <b>Programa Operativo Anual 2016<br>
  </tr>
</table>
<hr>
<table width='100%' border='1' cellspacing='0' cellpadding='2'>
  ...
  <tr>
    <td>Clasificacion</td>
    <td colspan='3'>".$res_proyecto['clasificacion']." - ".$res_proyecto['n_clas']."</td>
  </tr>
  <tr>
    <td>Inversion</td>
...
$titutlo_pdf ="Reporte del Proyecto: ". $res_proyecto['num']." - ".$res_proyecto['nombre'];
