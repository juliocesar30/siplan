...
<input type="hidden" id='id_componente' value="<?php echo $_GET['c'];?>">
...
&nbsp;&nbsp;
<div class="btn-group">
<a href="main.php?token=<?php echo md5(10)."&p=".$_GET['p']."&c=".$_GET['c']; ?>" class="btn btn-outline btn-default" data-toggle="tooltip" data-placement="bottom" title="Importar a PDF">&nbsp;<i class="fa fa-plus" aria-hidden="true"></i> Nuevo</a>
...
function listar(){
     $.ajax({
       method: "POST",
       url: "class/actividades.php",
       data: { accion: 1,componente: $('#id_componente').val() }
})
  .done(function(msg) {
