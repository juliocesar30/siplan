...
<div class="row">
    <div class="col-lg-4">
        <div class="form-group" id="ejes_div"></div>
    </div>
    <div class="col-lg-4">
...
<div class="row">
    ...
    <div class="col-lg-3">
        <div class="form-group" id="pnd_objetivo_div">
            ...
            <select class='form-control m-b' id="sltObjPND" name="sltObjPND"><option>-Sleccione Eje PND-</option></select>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group" id="pnd_estrategia_div">
            <label for="sltEstrategiaPND">Estrategia PND</label>
            <select class='form-control m-b' id="sltEstrategiaPND" name="sltEstrategiaPND"><option>-Sleccione Eje PND-</option></select>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group" id="pnd_linea_div">
            <label for="sltLineaPND">Línea de Acción PND</label>
            <select class='form-control m-b' id="sltLineaPND" name="sltLineaPND"><option>-Sleccione Eje PND-</option></select>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-3">
        <div class="form-group" >
            ...
            <input type="number" id="intPonderacion" name="intPonderacion" class="form-control" >
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-4">
        <div class="form-group" >
            ...
            <textarea class="form-control" rows="4" id="txtObjetivo" name="txtObjetivo"></textarea>
        </div>
    </div>
     <div class="col-lg-4">
        <div class="form-group" >
            <label for="txtProposito">Propósito</label>
            <textarea class="form-control" rows="4" id="txtProposito" name="txtProposito"></textarea>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group" >
            <label for="txtJustificacion">Justificación</label>
            <textarea class="form-control" rows="4" id="txtJustificacion" name="txtJustificacion"></textarea>
        </div>
    </div>
</div>
...
<div class="col-lg-4">
  ...
  <input type="number" id="intBenMuj" name="intBenMuj" class="form-control" >
    </div>
</div>
<div class="col-lg-4" >
    <div class="form-group" >
       <label for="intBenHom">Beneficiarios Hombres</label>
  <input type="number" id="intBenHom" name="intBenHom" class="form-control" >
    </div>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="txtUmedida" name="txtUmedida">
    </div>
</div>
<div class="col-lg-4">
    <div class="form-group">
         <label for="intProgAnual">Programado Anual</label>
        <input type="number" class="form-control" id="intProgAnual" name="intProgAnual">
    </div>
</div>
<div class="col-lg-4">
    <div class="form-group">
        <label for="intProgSem">Programado Semestral</label>
        <input type="number" class="form-control" id="intProgSem" name="intProgSem">
    </div>
</div>
</div>
...
<div class="col-lg-4">
    <div class="form-group" id="funcion_div">
        ...
        <select id="sltFuncion" name="sltFuncion" class='form-control m-b'><option>-Seleccione Finalidad-</option></select>
    </div>
</div>
<div class="col-lg-4">
    <div class="form-group" id="subfuncion_div">
        <label for="sltSubFuncion">Sub-Función</label>
        <select id="sltSubFuncion" name="sltSubFuncion" class='form-control m-b'><option>-Seleccione Finalidad-</option></select>
    </div>
</div>
</div>
